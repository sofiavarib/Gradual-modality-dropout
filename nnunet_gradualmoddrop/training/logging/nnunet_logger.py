...
class nnUNetLogger(object):
    ...
    def __init__(self, verbose: bool = False):
        self.my_fantastic_logging = {
            ...
            'epoch_end_timestamps': list(),'loss_rec_train':list(),'loss_rec_val':list()
        }
    ...
    def plot_progress_png(self, output_folder):
        ...
        ax.plot(x_values, self.my_fantastic_logging['loss_rec_train'][:epoch + 1], color='y', ls='-', label="loss_rec_t", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['loss_rec_val'][:epoch + 1], color='m', ls='-', label="loss_rec_v", linewidth=4)
